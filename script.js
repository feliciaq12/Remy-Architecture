...
function populateFilterOptions(selectId, values, placeholder) {
...
function renderSearchableTable(enrichedEvents) {
  ...
  populateFilterOptions(
    "venueFilter",
    [...new Set(sorted.map((e) => e.venue).filter(isValid))].sort((a, b) => a.localeCompare(b)),
    "All venues"
  );

  populateFilterOptions(
    "sectorFilter",
    [...new Set(sorted.map((e) => e.sector).filter(isValid))].sort((a, b) => a.localeCompare(b)),
    "All sectors"
  );
